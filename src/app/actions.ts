...
export { getClassificacoes, getKpisClassificacao, getSegmentacaoData, getCoberturaPorSegmentacao, getMedicosPorPotencial } from './actions/segmentacao';
export type { CoberturaSegmentacao } from './actions/segmentacao';
